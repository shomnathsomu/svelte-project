...
var app = (function () {
    ...
    /* src\layout\Navbar.svelte generated by Svelte v3.12.1 */
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "Svelte Tutorial";
    			attr_dev(span, "class", "brand-logo");
    			add_location(span, file$1, 7, 21, 159);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot_2.name, type: "slot", source: "(8:8) <Link to=\"/\">", ctx });
    	return block;
    }
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot_1.name, type: "slot", source: "(10:14) <Link to=\"/\">", ctx });
    	return block;
    }
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot.name, type: "slot", source: "(11:14) <Link to=\"/about\">", ctx });
    	return block;
    }

    function create_fragment$3(ctx) {
    	var nav, div1, div0, t0, ul, li0, t1, li1, current;
    	...
    	const block = {
    		c: function create() {
    			...
    			li1 = element("li");
    			link2.$$.fragment.c();
    			add_location(li0, file$1, 9, 10, 290);
    			add_location(li1, file$1, 10, 10, 335);
    			attr_dev(ul, "id", "nav-mobile");
    			attr_dev(ul, "class", "right hide-on-med-and-down");
    			add_location(ul, file$1, 8, 8, 223);
    			attr_dev(div0, "class", "container");
    			add_location(div0, file$1, 6, 6, 113);
    			attr_dev(div1, "class", "nav-wrapper");
    			add_location(div1, file$1, 5, 4, 80);
    			add_location(nav, file$1, 4, 2, 69);
    		},
    ...
    /* src\components\PostForm.svelte generated by Svelte v3.12.1 */

    const file$2 = "src\\components\\PostForm.svelte";

    function create_fragment$4(ctx) {
    	var form, div0, label0, t1, input0, t2, div1, label1, t4, input1, t5, button, dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$2, 29, 8, 621);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$2, 30, 8, 663);
    			attr_dev(div0, "class", "input-field");
    			add_location(div0, file$2, 28, 4, 586);
    			attr_dev(label1, "for", "body");
    			add_location(label1, file$2, 33, 8, 756);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$2, 34, 8, 796);
    			attr_dev(div1, "class", "input-field");
    			add_location(div1, file$2, 32, 4, 721);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "waves-effect waves-light btn");
    			add_location(button, file$2, 36, 4, 853);
    			add_location(form, file$2, 27, 0, 551);
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, ctx.title);
    			...
    			set_input_value(input1, ctx.body);
    		...
    		p: function update(changed, ctx) {
    			if (changed.title && (input0.value !== ctx.title)) set_input_value(input0, ctx.title);
    			if (changed.body && (input1.value !== ctx.body)) set_input_value(input1, ctx.body);
    		},
    ...
    class PostForm extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "PostForm", options, id: create_fragment$4.name });
    	}
    }
    ...
    function create_else_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_else_block$1.name, type: "else", source: "(45:4) {:else}", ctx });
    	return block;
    }

    // (43:4) {#if posts.length === 0}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "Loading posts...";
    			add_location(h3, file$3, 43, 8, 911);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$1.name, type: "if", source: "(43:4) {#if posts.length === 0}", ctx });
    	return block;
    }

    // (46:8) {#each posts as post}
    function create_each_block(ctx) {
    	var div3, div2, div0, p0, t0_value = ctx.post.title + "", t0, t1, p1, t2_value = ctx.post.createdAt + "", t2, t3, p2, t4_value = ctx.post.body + "", t4, t5, div1, a0, t7, a1, t9, dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = space();
    			attr_dev(p0, "class", "card-title svelte-f8a3e");
    			add_location(p0, file$3, 49, 24, 1124);
    			attr_dev(p1, "class", "timestamp svelte-f8a3e");
    			add_location(p1, file$3, 50, 24, 1188);
    			add_location(p2, file$3, 51, 24, 1255);
    			attr_dev(div0, "class", "card-content");
    			add_location(div0, file$3, 48, 20, 1072);
    			attr_dev(a0, "href", "#");
    			add_location(a0, file$3, 54, 24, 1374);
    			attr_dev(a1, "href", "#");
    			attr_dev(a1, "class", "delete-btn svelte-f8a3e");
    			add_location(a1, file$3, 55, 24, 1452);
    			attr_dev(div1, "class", "card-action");
    			add_location(div1, file$3, 53, 20, 1323);
    			attr_dev(div2, "class", "card svelte-f8a3e");
    			add_location(div2, file$3, 47, 16, 1032);
    			attr_dev(div3, "class", "col s6");
    			add_location(div3, file$3, 46, 12, 994);

    			dispose = [
    				listen_dev(a0, "click", click_handler),
    				listen_dev(a1, "click", click_handler_1)
    			];
    		},
    		...
    		p: function update(changed, new_ctx) {
    			...
    			if ((changed.posts) && t2_value !== (t2_value = ctx.post.createdAt + "")) {
    				set_data_dev(t2, t2_value);
    			}

    			if ((changed.posts) && t4_value !== (t4_value = ctx.post.body + "")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(46:8) {#each posts as post}", ctx });
    	return block;
    }

    function create_fragment$5(ctx) {
    	var div1, div0, t, div2, current;

    	var postform = new PostForm({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 36, 4, 788);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$3, 35, 0, 765);
    			attr_dev(div2, "class", "row");
    			add_location(div2, file$3, 41, 0, 854);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, div0);
    			mount_component(postform, div0, null);
    			insert_dev(target, t, anchor);
    ...
    const apiBaseUrl$1 = "https://ndb99xkpdk.execute-api.eu-west-2.amazonaws.com/dev";
    ...
    function instance$4($$self, $$props, $$invalidate) {
        ...
        let posts=[];
        onMount(async () => {
            const res = await fetch(apiBaseUrl$1 + '/posts');
            $$invalidate('posts', posts = await res.json());
        });

    	const click_handler = ({ post }) => editPost(post);
    	...
    	return { posts, click_handler, click_handler_1 };
    }
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 17, 1, 386);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot$1.name, type: "slot", source: "(16:0) <Router>", ctx });
    	return block;
    }
